...
export function KanbanCard({ lead }: KanbanCardProps) {
  ...
  return (
    <div
      ...
      {...attributes}
      {...listeners}
      className="bg-white p-3 rounded-md shadow-sm border border-slate-200 hover:shadow-md transition-shadow cursor-grab active:cursor-grabbing group touch-none"
    >
